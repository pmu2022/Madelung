...
!
   ...
   integer (kind=IntKind) :: jl, l, jmax, lig, m
   integer (kind=IntKind), pointer :: flag_jl(:)
!
...
!
         ...
         do jl = 1, jmax
            if ( flag_jl(jl) /= 0 ) then
               ...
               print *, "ppp1", jl, den_in(1)
               print *, "ppp2", jl, den_in(nr_ps)
               print *, "ppp3", jl, den_in(nr_ps - 1)
         ...
         do ia = 1, p_CDL%NumSpecies
            ...
            do jl = 1, jmax
               if ( flag_jl(jl) /= 0 ) then
                  ...
                  write(6,'(a,4i5,ES26.12,ES26.12)') "ia,jl,l,m", ia,jl,l,m,real(p_mm(jl),kind=RealKind),aimag(p_mm(jl))
