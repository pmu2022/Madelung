...
lsms::matrix<double> lsms::create_lattice(const lsms::matrix<double> &brav, double cutoff,
...
std::tuple<lsms::matrix<double>, std::vector<double>> lsms::create_lattice_and_sq(
    lsms::matrix<double> &brav, double cutoff, const std::vector<int> &nm, int size) {
  lsms::matrix<double> latt_vec(3, size);
  std::vector<double> latt_vec_sq(size);
